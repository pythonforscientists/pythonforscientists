...
\input{2developmentbasics}

\input{3basicdatatypes}

\input{4general}

\input{5complexdatatypes}

\input{6conditionallogic}

\input{7datastructures}

\input{8filehandling}

\input{9jupyternotebooks}

\input{10pandas}

\input{11beautifulsoup}
