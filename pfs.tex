...
\newcommand{\bookversion}{0.1.9039}
...
\par\noindent\rule{0.95\textwidth}{4pt}\\
...
% ---- Author Page ----
% current geometry will be restored after title page
\noindent Sejin Kim '22 was a student at Kenyon College studying scientific computing. He served as a lead tutor for introductory programming courses in the Department of Scientific Computing and is now a systems analyst using Python. He can be contacted at \verb|kim3[AT]kenyon.edu|.
% ---- End of Author Page ----
