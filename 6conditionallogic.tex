...
\begin{Exercise}
    ...
    \Question{Using exactly two lines of code and the variable \verb|a| as the iterator in your loop, print $a$ asterisks, with each set of $a$ asterisks on their own line, with the shortest line being just one asterisk and the longest line being ten asterisks. It should look like this:\\\verb|*|\\\verb|**|\\\verb|***|\\\verb|****|\\\verb|*****|\\\verb|******|\\\verb|*******|\\\verb|********|\\\verb|*********|\\\verb|**********|}
\end{Exercise}
\section{While Loops}
