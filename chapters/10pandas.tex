...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cycling.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/cereal.csv}{https://pythonforscientists.github.io/data/data/cereal.csv}. The dataset contains race results for the 2021 Tour of Flanders cycling race.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|tourflanders21|.}
