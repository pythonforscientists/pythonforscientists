...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/fifa.csv}{https://pythonforscientists.github.io/data/data/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
...
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/fifa.csv}{https://pythonforscientists.github.io/data/data/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|fifa|.}
	\Question{What are the dimensions of the dataframe? How many columns and rows does the dataframe have?}
	\Question{What are the column names of the \verb|fifa| dataframe?}
	\Question{Print a series with the datatypes of the \verb|fifa| dataframe.}
	\Question{What is the type of the \verb|composure| column as reported by Pandas?}
	\Question{What is the type of the \verb|composure| column as reported by Python?}
	\Question{Are the datatypes for the \verb|composure| the same when reported by Pandas or by Python? Why or why not?}
	\Question{What is the type of the \verb|name| column as reported by Pandas?}
	\Question{What is the type of the \verb|name| column as reported by Python?}
	\Question{Are the datatypes for the \verb|name| the same when reported by Pandas or by Python? Why or why not?}
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cycling.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/cycling.csv}{https://pythonforscientists.github.io/data/data/cycling.csv}. The dataset contains race results for the 2021 Tour of Flanders cycling race.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|tourflanders21|.}
	\Question{What are the dimensions of the dataframe? How many columns and rows does the dataframe have?}
	\Question{What are the column names of the \verb|tourflanders21| dataframe?}
	\Question{Print a series with the datatypes of the \verb|tourflanders21| dataframe.}
	\Question{What is the type of the \verb|uci| column as reported by Pandas?}
	\Question{What is the type of the \verb|uci| column as reported by Python?}
	\Question{Are the datatypes for the \verb|uci| the same when reported by Pandas or by Python? Why or why not?}
	\Question{What is the type of the \verb|team| column as reported by Pandas?}
	\Question{What is the type of the \verb|team| column as reported by Python?}
	\Question{Are the datatypes for the \verb|team| the same when reported by Pandas or by Python? Why or why not?}
\end{Exercise}
...
Let's start by importing this dataset. The data are located at\\ \href{https://pythonforscientists.github.io/data/data/hockey.csv}{https://pythonforscientists.github.io/data/data/hockey.csv} as a CSV file, so we can import it into Python as a \indexterm{Pandas} dataframe\index{Pandas!dataframe} by using the \verb|read_csv| method in \indexterm{Pandas}.\par
...
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/fifa.csv}{https://pythonforscientists.github.io/data/data/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
	\Question{Print just the names, separated by a newline, using dataframe row iteration.}
	\Question{Print the names and the vision score, with each name separated by a new line, using dataframe row iteration.}
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cereal.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/cereal.csv}{https://pythonforscientists.github.io/data/data/cereal.csv}. The dataset contains price data for wheat, rice, and corn from 1992 to 2021.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|cereal|.}
	\Question{What is the last row of the cereal dataframe? Hint: Print the dataframe using negative indexing.}
	\Question{2021 is missing the December entry. Add the following data for each of the columns.\\
	Year: 2021\\
	Month: Dec\\
	Price\_wheat\_ton: 332.06\\
	Price\_rice\_ton: 400.0\\
	Price\_corn\_ton: 264.54\\
	Inflation\_rate: -1.29\\
	Price\_wheat\_ton\_infl: 327.78\\
	Price\_rice\_ton\_infl: 394.84\\
	Price\_corn\_ton\_infl: 261.13}
\end{Exercise}
...
\begin{Exercise}
	\Question{Consider the \verb|cereal.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/cereal.csv}{https://pythonforscientists.github.io/data/data/cereal.csv}. The dataset contains price data for wheat, rice, and corn from 1992 to 2021.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|cereal|.}
	\Question{Remove every row from before the year 2000.}
	\Question{Remove the \verb|Inflation_rate| column.}
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cycling.csv| file, which is located at\\ \href{https://pythonforscientists.github.io/data/data/cereal.csv}{https://pythonforscientists.github.io/data/data/cycling.csv}. The dataset contains race results for the 2021 Tour of Flanders cycling race.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|tourflanders21|.}
	\Question{Remove all of the rows where the rider last name starts with \verb|A|. The \verb|rider| column is formatted as LAST First. Hint: Use string subsetting to determine whether the first letter of the \verb|rider| column is exactly equal to \verb|A|.}
\end{Exercise}
...
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| dataset, which is located at\\ \href{https://pythonforscientists.github.io/data/data/fifa.csv}{https://pythonforscientists.github.io/data/data/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
	\Question{What is the mean and median of the \verb|vision| column?}
	\Question{What is the lowest \verb|strength| score?}
	\Question{What is the highest \verb|agility| score?}
	\Question{Who is the player with the lowest \verb|acceleration| score?}
	\Question{Who is the player with the highest \verb|speed| score?}
\end{Exercise}
