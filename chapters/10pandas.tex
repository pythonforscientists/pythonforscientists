...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| file, which is located at\\ \href{https://github.com/pythonforscientists/data/raw/main/fifa.csv}{https://github.com/pythonforscientists/data/raw/main/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cycling.csv| file, which is located at\\ \href{https://github.com/pythonforscientists/data/raw/main/cycling.csv}{https://github.com/pythonforscientists/data/raw/main/cycling.csv}. The dataset contains race results for the 2021 Tour of Flanders cycling race.}
...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cereal.csv| file, which is located at\\ \href{https://github.com/pythonforscientists/data/raw/main/cereal.csv}{https://github.com/pythonforscientists/data/raw/main/cereal.csv}. The dataset contains price data for wheat, rice, and corn from 1992 to 2021.}
...
\end{Exercise}
\begin{Exercise}
	\Question{Consider the \verb|cycling.csv| file, which is located at\\ \href{https://github.com/pythonforscientists/data/raw/main/cycling.csv}{https://github.com/pythonforscientists/data/raw/main/cereal.csv}. The dataset contains race results for the 2021 Tour of Flanders cycling race.}
	\Question{Read the CSV file into Pandas with the default settings into a variable called \verb|tourflanders21|.}
...
\begin{Exercise}
	\Question{Consider the \verb|fifa.csv| dataset, which is located at\\ \href{https://github.com/pythonforscientists/data/raw/main/fifa.csv}{https://github.com/pythonforscientists/data/raw/main/fifa.csv}. The dataset contains basic scores for players in the FIFA 19 video game.}
